...
const entities = {
	[mockArticles[0].id]: mockArticles[0],
	[mockArticles[1].id]: mockArticles[1],
	[mockArticles[2].id]: mockArticles[2],
	[mockArticles[3].id]: mockArticles[3],
};

export const mockArticlesEntities: EntityState<Article> = {
	entities,
	ids: ['1', '2', '3', '4'],
};
