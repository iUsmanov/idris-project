...
Готовый билд проекта - https://imaginative-twilight-6d058f.netlify.app/. Однако тут работать будут только
GET-запросы на сервер, остальные запросы будут выдавать ошибку. Поэтому, например, изменить профиль у вас не получится.
