...
используется собственный eslint plugin `fsd-paths-guard`,
...
Разрешено использование _feature flags_ только с помощью хелпера `toggleFeatures`
...
Компонент [ToggleFeatures](/src/shared/lib/featureFlags/components/ToggleFeatures/ToggleFeatures.tsx) работает похожим образом
